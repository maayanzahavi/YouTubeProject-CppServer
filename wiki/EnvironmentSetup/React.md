__Pay attention__: Part 4 is under the branch `mainPart4`.
 The server for part 4 can be found at [this link](https://github.com/maayanzahavi/WebPart2.git), 
 and the React application itself is available [here](https://github.com/maayanzahavi/WebPart2-React.git) under the same branch`mainPart4`.
